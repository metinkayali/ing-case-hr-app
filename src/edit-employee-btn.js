...
export class EditEmployeeBtn extends EmployeeListBtnBase { 
  render() {
    return html`
  ...
  _onClick() {
    this.dispatch(requestEditEmployee({ employeeId: this.employeeId }))
  }
}
customElements.define('ing-case-edit-employee-btn', EditEmployeeBtn);
